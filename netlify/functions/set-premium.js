...
exports.handler = async (event) => {
  ...
  const { email, is_premium, plan, code } = body;
  ...
  // Vérification seule (is_premium null ET pas de plan)
  ...
  // Déterminer les nouvelles métadonnées
  ...
  if (plan === 'pro') {
    ...
    // Ancienne méthode — active Pro par défaut
    newMeta.plan = 'pro';
    newMeta.is_premium = true;
  }
